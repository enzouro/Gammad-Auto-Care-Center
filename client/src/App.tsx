...
const App = () => {
  ...
  const checkUserAuthorization = async () => {
    try {
      ...
      const response = await fetch(`https://gammad-auto-care-center.onrender.com/api/v1/users/${parsedUser.userid}`, {
        headers: {
  ...
  const authProvider: AuthProvider = {
    login: async ({ credential }: CredentialResponse) => {
      ...
      if (profileObj) {
        const response = await fetch('https://gammad-auto-care-center.onrender.com/api/v1/users', {
          method: 'POST',
  ...
  return (
    <ColorModeContextProvider>
      ...
      <RefineSnackbarProvider>
        <Refine
          dataProvider={dataProvider('https://gammad-auto-care-center.onrender.com/api/v1')}
